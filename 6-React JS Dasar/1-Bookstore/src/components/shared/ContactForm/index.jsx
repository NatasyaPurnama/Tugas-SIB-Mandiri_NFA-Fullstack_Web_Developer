      ...
      <div className="container py-5">
        <div className="row justify-content-between align-items-start">
          <div className="col-md-6 mb-4">
            <h2 className="fw-bold mb-3">Masukanmu Membantu Kami Lebih Baik</h2>
          ...
          <div className="col-md-5">
            <form>
              <div className="mb-3">
                ...
                <select
                  className={`form-select input ${styles.formSelectinput}`}
                  id="topik"
                  required
                >
              ...
              <div className="mb-3">
                ...
                <input
                  type="text"
                  className={`form-control input ${styles.formControlinput}`}
                  id="nama"
